...
const sections: Section[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Le confezioni con confidenza bassa o non riconosciute restano segnalate: scatta una foto mirata aggiuntiva per quella specifica confezione (es. per farle leggere la scadenza), poi premi \"✨ Rianalizza con IA\" sotto quella confezione per far rileggere al modello tutte le sue foto insieme (senza creare una confezione duplicata), oppure premi \"Rivedi/Modifica\" per correggere i dati a mano. Puoi anche aggiungere una confezione a mano in qualsiasi momento se l'IA non la individua.",
      "Dopo aver salvato i dati con \"Rivedi/Modifica\", il pannello resta aperto e subito sotto compaiono i pulsanti per confermare la confezione (nuovo farmaco o aggiornamento di uno già censito), senza dover cercarli altrove nella lista.",
